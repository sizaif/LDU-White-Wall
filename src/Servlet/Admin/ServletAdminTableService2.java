...
@WebServlet(name = "ServletAdminTableService2",urlPatterns = "/ServletAdminTableService2")
public class ServletAdminTableService2 extends HttpServlet {
        ...
        try {
            ...
            if(type==null){
                if( Dao.equalsIgnoreCase("user")){
                    ...
                    session.setAttribute("Mark","user"); //标志
                    session.setAttribute("userPageList",userDaoImp.listByPage(startIndex,perPageCount));
                    ...
                    session.setAttribute("Mark","anecdote"); //标志
                    session.setAttribute("AnecdotePageList",anecdoteDaoImp.getPageArticle(startIndex,perPageCount));
                    session.setAttribute("Page",currentPage);
                    session.setAttribute("totalPage",totalPage);
                    session.setAttribute("totalCount",totalCount);
                ...
                session.setAttribute("Mark",Dao); //标志
                if(Dao.equalsIgnoreCase("user")){

                    List<User> list = userDaoImp.SearchUserFuzzyByNick(SearchCont);
                    ...
                    session.removeAttribute("totalPage");
                    session.setAttribute("Mark","user"); //标志
                    session.setAttribute("userPageList",list);
                    session.setAttribute("Page",currentPage);
                    session.setAttribute("totalPage",totalPage);
                    session.setAttribute("totalCount",totalCount);
                }
