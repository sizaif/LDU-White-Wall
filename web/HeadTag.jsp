...
<head>
    ...
    <%--雪花背景--%>
    <link href="/extend/snow/css/style.css" type="text/css"   rel="stylesheet">
</head>
<body>
    <%--雪花背景--%>
    <div>
        <script src="/extend/snow/js/three.min.js"></script>
        ...
        <script src="/extend/snow/js/index.js"></script>
    </div>
</body>