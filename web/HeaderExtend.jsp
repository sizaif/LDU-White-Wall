...
<head>
    ...
    <link rel="icon" type="image/png" href="/extent/assets/i/favicon.png">
    ...
    <%--<link rel="apple-touch-icon-precomposed" href="/extent/assets/i/app-icon72x72@2x.png">--%>

    <!-- Tile icon for Win8 (144x144 + tile color) -->
    <%--<meta name="msapplication-TileImage" content="/extent/assets/i/app-icon72x72@2x.png">--%>
